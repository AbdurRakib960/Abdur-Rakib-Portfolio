  ...
  return (
    <div>
      <div class="projects row row-cols-1 row-cols-md-2 m-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                Authentication service is enabled. Only a logged in user can add
                a service. Firebase and JWT token are also used. So only a valid
                user can access or add a service.
              </p>
              <div className="icon">
                <a
                  className="mr-4 pr-4"
        ...
        <div class="col mb-4">
          <div class="card">
            <img src={project2} class="card-img-top" alt="Volunteer network" />
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                Only a logged in user can add a service. Firebase and JWT token
                are also used.
              </p>
              <a
                className="mr-4 pr-4"
        ...
        <div class="col mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                A tour booking system project. A customer can book a tour. Also,
                a customer can see hotels based on their destination. Only
                logged in user can book a room. Google map is also added.Travel
                lover can login the site for visiting a nice place and choice a
                perfect hotel.
              </p>
              <a
                className="mr-4 pr-4"
        ...
        <div class="col mb-4">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Comment Book</h5>
              <p class="card-text">
                Comment Book is a simple react page with Material UI design.The
                page is just for practicing purposes.It's like face comment
                system.The user can comment on a post admin can see all the
                comments from users.The user can send a friend request and admin
        ...
        <div class="col mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
              ema-john is a react based and commercial website. There are a lot of products on the home page. Anyone can order a product. Before ordering the products, you have two payment first. In the cart section total amount will added with vat, shipping charge and etc.
              </p>
              <a
                className="mr-4 pr-4"
